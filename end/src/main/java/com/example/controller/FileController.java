...
public class FileController {
    ...
    public Result<String> upload(MultipartFile file) {
        String filePath = System.getProperty("user.dir") + "/end/src/main/resources/static/file/";
    ...
    public void avatarPath(@PathVariable String flag, HttpServletResponse response) {
        OutputStream os;
        String basePath = System.getProperty("user.dir") + "/end/src/main/resources/static/file/";
