<template>
  <div>
    ...
    <div style="width: 100%; height: 60px; line-height: 60px; background-color: white">
      <el-row>
        <el-col :span="4">
          <div style="font-size: 20px; font-weight: bold; text-align: center"><a style="color: #409EFF;" href="/front/home">网上订餐系统</a></div>
        </el-col>
        <el-col :span="10">
...
<!--    底部-->
    <div style="height: 50px; width: 100%; background-color: white; padding: 10px 0; position: fixed; bottom: 0">
