  ...
  <div>
    ...
    <div style="margin-top: 10px">
      <el-row :gutter="10">
        ...
        <el-col :span="18">
          <el-card>
            <div style="padding: 10px 0; border-bottom: 2px solid orangered; font-size: 20px; color: orangered">推荐菜品</div>
...
<!--        热销菜品-->
        <el-col :span="6">
          <el-card>
            <div style="padding: 10px 0; border-bottom: 2px solid dodgerblue; font-size: 20px; color: dodgerblue">热销菜品</div>
